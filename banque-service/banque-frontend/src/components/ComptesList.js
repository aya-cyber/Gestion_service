...
function ComptesList() {
    ...
    return (
        <div>
                ...
                {data.allComptes.map((compte) => (
                    ...
                    >
                        ...
                        <button
                            ...
                            onClick={() => handleSelectCompte(compte.id)} // Passer l'ID du compte sélectionné
                        >
            ...
            {/* Afficher les transactions si un compte est sélectionné */}
            {selectedCompteId && (
                <div style={{ marginTop: '20px' }}>
                    <h2>Transactions du Compte ID: {selectedCompteId}</h2>
                    <TransactionsList compteId={selectedCompteId} /> {/* Passer l'ID du compte */}
                </div>
            )}
